...
public class PropertyPersistenceImpl extends BasePersistenceImpl<Property>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_USERID = new FinderPath(PropertyModelImpl.ENTITY_CACHE_ENABLED,
			PropertyModelImpl.FINDER_CACHE_ENABLED, PropertyImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERID =
		new FinderPath(PropertyModelImpl.ENTITY_CACHE_ENABLED,
			PropertyModelImpl.FINDER_CACHE_ENABLED, PropertyImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByuserId",
			new String[] { Long.class.getName() },
			PropertyModelImpl.USERID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_USERID = new FinderPath(PropertyModelImpl.ENTITY_CACHE_ENABLED,
			PropertyModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Property> findByuserId(long userId) throws SystemException {
	 ...
	 */
	@Override
	public List<Property> findByuserId(long userId, int start, int end)
	...
	public List<Property> findByuserId(long userId, int start, int end,
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_PROPERTY_WHERE);
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(PropertyModelImpl.ORDER_BY_JPQL);
			}
	 ...
	 */
	@Override
	public Property findByuserId_First(long userId,
		OrderByComparator orderByComparator)
		throws NoSuchPropertyException, SystemException {
		Property property = fetchByuserId_First(userId, orderByComparator);
	 ...
	 */
	@Override
	public Property fetchByuserId_First(long userId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Property> list = findByuserId(userId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Property findByuserId_Last(long userId,
		OrderByComparator orderByComparator)
		throws NoSuchPropertyException, SystemException {
		Property property = fetchByuserId_Last(userId, orderByComparator);
	 ...
	 */
	@Override
	public Property fetchByuserId_Last(long userId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Property> list = findByuserId(userId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Property[] findByuserId_PrevAndNext(long propertyId, long userId,
		OrderByComparator orderByComparator)
		throws NoSuchPropertyException, SystemException {
		Property property = findByPrimaryKey(propertyId);
		...
		try {
			...
			Property[] array = new PropertyImpl[3];

			array[0] = getByuserId_PrevAndNext(session, property, userId,
					orderByComparator, true);

			array[1] = property;

			array[2] = getByuserId_PrevAndNext(session, property, userId,
	...
	protected Property getByuserId_PrevAndNext(Session session,
		Property property, long userId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(property);
	...
	public void removeByuserId(long userId) throws SystemException {
		for (Property property : findByuserId(userId, QueryUtil.ALL_POS,
	...
	public int countByuserId(long userId) throws SystemException {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_PROPERTY_WHERE);
	...
	private static final String _FINDER_COLUMN_USERID_USERID_2 = "property.userId = ?";
	...
	public Property updateImpl(com.liferay.sample.model.Property property)
		...
		PropertyModelImpl propertyModelImpl = (PropertyModelImpl)property;
		...
		if (isNew || !PropertyModelImpl.COLUMN_BITMASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}

		else {
			if ((propertyModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						propertyModelImpl.getOriginalUserId()
					};
				...
				args = new Object[] { propertyModelImpl.getUserId() };
	...
	private static final String _SQL_SELECT_PROPERTY_WHERE = "SELECT property FROM Property property WHERE ";
	private static final String _SQL_COUNT_PROPERTY = "SELECT COUNT(property) FROM Property property";
	private static final String _SQL_COUNT_PROPERTY_WHERE = "SELECT COUNT(property) FROM Property property WHERE ";
	...
	private static final String _NO_SUCH_ENTITY_WITH_KEY = "No Property exists with the key {";
