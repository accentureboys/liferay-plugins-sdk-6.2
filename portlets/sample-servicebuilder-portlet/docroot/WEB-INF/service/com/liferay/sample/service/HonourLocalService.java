...
/**
 * Provides the local service interface for Honour. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author jasonxiang
 * @see HonourLocalServiceUtil
...
public interface HonourLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HonourLocalServiceUtil} to access the honour local service. Add custom service methods to {@link com.liferay.sample.service.impl.HonourLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
