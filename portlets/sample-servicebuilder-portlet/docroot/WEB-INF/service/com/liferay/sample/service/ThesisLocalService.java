...
/**
 * Provides the local service interface for Thesis. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author jasonxiang
 * @see ThesisLocalServiceUtil
...
public interface ThesisLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ThesisLocalServiceUtil} to access the thesis local service. Add custom service methods to {@link com.liferay.sample.service.impl.ThesisLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
