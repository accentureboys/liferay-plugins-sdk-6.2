...
/**
 * Provides the local service interface for Major. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author jasonxiang
 * @see MajorLocalServiceUtil
...
public interface MajorLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MajorLocalServiceUtil} to access the major local service. Add custom service methods to {@link com.liferay.sample.service.impl.MajorLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
